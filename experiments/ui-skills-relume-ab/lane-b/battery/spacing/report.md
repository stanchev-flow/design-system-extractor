...
Generated 2026-07-18T23:44:01Z · viewport 1440x900 · contract: `brand_pipeline/spec/spacing-conformance.md` · tolerance: max(2px, 10%) for rhythm; max(2px, 1%) for widths; drift = within 2x tolerance.
...
|---|---|---|---|---|---|---|---|---|
| lane-b | 2026-07-19 00:43:04 | 73 | 64 | 1 | 1 | 0 | 7 | **1** |

## lane-b

`/Users/stanchev/Webflow/campaigns-hackathon/design-system-extractor-mine/experiments/ui-skills-relume-ab/lane-b/index.html` (mtime 2026-07-19 00:43:04)
...
| `header.body-to-meta` | 32px x1 | heading-to-body (32px) | sec-3(testimonial) |
...
| type | sec-3 (testimonial) | 14px x1 | measured | type fact 14px | c-caption |
...
| space | sec-3 (testimonial) | 32px x1 | on-scale | derived step 32px | header.body-to-meta |
...
| sec-3 (testimonial) | `section.pad-top` | 40px | testimonial-tab-stats.bandPadding.top (40px) | +0px | conform |  |
| sec-3 (testimonial) | `section.pad-bottom` | 24px | testimonial-tab-stats.bandPadding.bottom (24px) | +0px | conform |  |
| sec-3 (testimonial) | `header.body-to-meta` | 32px | — | — | unmapped | .cs-split-body |
| sec-3 (testimonial) | `split.column-gap` | 90px | column-to-column (80px) | +10px | drift | split columns |
...
| sec-4 (pricing) | `grid.column-gap` | 32px | grid-gap (32px) | +0px | conform | .cs-modules column |
| sec-4 (pricing) | `grid.column-gap` | 32px | grid-gap (32px) | +0px | conform | .cs-modules column |
...
| sec-2→sec-3 (results→testimonial) | `section.seam` | 104px | award-badge-row.bandPadding.top+case-study-header-rail.bandPadding.top (104px) | +0px | conform |  |
| sec-3→sec-4 (testimonial→pricing) | `section.seam` | 88px | testimonial-tab-stats.bandPadding.bottom+case-study-header-rail.bandPadding.top (88px) | +0px | conform |  |
