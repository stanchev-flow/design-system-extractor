...
Generated: 2026-07-18T23:36:23+00:00 — auditor v1.0.0 — mode: strict
...
|---|---|---|---|
| lane-a | `/Users/stanchev/Webflow/campaigns-hackathon/design-system-extractor-mine/experiments/ui-skills-relume-ab/lane-a/index.html` | 2026-07-18T23:35:53+00:00 | `f03f23e7abb6` |
...
|---|---|---|---|---|---|
| IC-NAV-05 | nav | advisory | static | **advisory** | anchor with role=button in nav chrome — promises Space activation anchors don't have (line 2922) |
| IC-LANG-01 | lang | required | static | **pass** | toggle is a native <summary> inside <details> (line 2912) |
| IC-LANG-02 | lang | required | static | **pass** | toggle has an accessible name (line 2912) |
...
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Products' is a native button (line 2916) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Solutions' is a native button (line 2918) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Resources' is a native button (line 2920) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Products' carries aria-expanded (line 2916) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Solutions' carries aria-expanded (line 2918) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Resources' carries aria-expanded (line 2920) |
| IC-NAV-03 | nav | required | static | **pass** | no ARIA menu/menubar roles in site nav |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2916) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2918) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2920) |
