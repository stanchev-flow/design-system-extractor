...
- Airy, never dense or app-like. Asymmetric editorial grids: uneven columns
  (1.6fr 1fr, 1.2fr 1fr), staggered sibling cards (offset with padding-top so they
  do NOT align), imagery allowed to sit off-grid and overlap section edges, with
  full-bleed imagery reserved for impact moments. Centered container, real gutters,
  deliberate vertical rhythm. The emptiness is the design — do not fill it.
