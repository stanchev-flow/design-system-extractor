...
- replica page: `index.html` → `replica-fullpage.png` (doc 6820px vs source 6986px)
...
- **overall score (height-weighted): 0.918**
...
| sec-0 | full-bleed-photo-hero — Where go-to-market teams go to 
               grow scale close retain grow | **0.925** | 0.911 | 0.899 | 1.000 | 1.000 | 772px | 772px | [side-by-side](diff/sec-0.png) |
...
| sec-3 | sticky-copy-with-card-grid — Growing a business is hard. HubSpot makes it easier. | **0.929** | 0.963 | 0.955 | 0.806 | 0.970 | 1600px | 1289px | [side-by-side](diff/sec-3.png) |
| sec-4 | headrail-split-with-card-carousel — Built-in AI agents that work for you 24/7. | **0.877** | 0.889 | 0.874 | 0.851 | 0.971 | 992px | 844px | [side-by-side](diff/sec-4.png) |
...
| sec-6 | headrail-two-col-header — Remarkable results for every size business. | **0.930** | 0.968 | 0.956 | 0.795 | 1.000 | 240px | 302px | [side-by-side](diff/sec-6.png) |
...
| sec-9 | dark-band-cta — Make impossible growth feel impossibly easy, with HubSpot | **0.915** | 0.951 | 0.936 | 0.794 | 0.571 | 335px | 422px | [side-by-side](diff/sec-9.png) |
| footer | footer (closing bookend) | **0.958** | 0.982 | 0.973 | 0.872 | 1.000 | 656px | 752px | [side-by-side](diff/footer.png) |
...
|---|---|---|---|---|---|---|---|---|
| 1440 | primary (fidelity) | 1.0 | 0 | 12 | 772px | 5 | 6820px | `replica-fullpage-1440.png` |
| 1920 | responsiveness | 1.0 | 0 | 12 | 952px | 5 | 7012px | `replica-fullpage-1920.png` |
| 960 | responsiveness | 1.0 | 0 | 12 | 664px | 5 | 7155px | `replica-fullpage-960.png` |
| 375 | responsiveness | 0.8933 | 20 (`cs-edgecut`) | 12 | 756px | 1 | 10614px | `replica-fullpage-375.png` |
...
| contentSpanFidelity | 0.9402 | 0.8 | yes | rebuilt content occupies the measured share of each band |

**Structural gate: pass**

## Renderer-gap punch list

1. **full-bleed-photo-hero — composite hero art** (score 0.925): composite hero art — the source layers an illustration with floating product-UI chips; the composer binds one asset per media slot (no multi-layer collage of tagged crops)
...
3. **dark-band-cta — content width diverges** (score 0.915): content span 0.40 of band vs source 0.71 (width fidelity 0.57) — check hug/measure collapse or over-wide container
