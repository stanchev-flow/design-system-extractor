...
- brand: **Remote**
- source screenshot: `screenshots/remote-v2/remote-com-fullpage.png`
...
|---|---|---|---|---|---|---|---|---|---|
| page-nav | navbar (chrome header) | **0.942** | 0.932 | 0.918 | 1.000 | 0.850 | 81px | 81px | [side-by-side](diff/page-nav.png) |
| sec-0 | hero — Global employment runs on Remote | **0.920** | 0.956 | 0.941 | 0.798 | 0.938 | 550px | 689px | [side-by-side](diff/sec-0.png) |
| sec-1 | logo-wall — section-1 | **0.889** | 0.956 | 0.949 | 0.629 | 0.972 | 256px | 161px | [side-by-side](diff/sec-1.png) |
| sec-2 | feature-accordion — One system of record. Every employment need. | **0.973** | 0.978 | 0.966 | 0.973 | 0.988 | 973px | 947px | [side-by-side](diff/sec-2.png) |
| sec-3 | infra-panel — Owned end-to-end infrastructure, operated in-house. | **0.983** | 0.990 | 0.972 | 0.980 | 1.000 | 699px | 713px | [side-by-side](diff/sec-3.png) |
| sec-4 | banner-cta — Hiring internationally, converting contractors, or consolidating payroll? Talk to our team. | **0.959** | 0.962 | 0.945 | 0.971 | 1.000 | 509px | 524px | [side-by-side](diff/sec-4.png) |
| sec-5 | workflow-cards — Your workflows, your way, on our infrastructure | **0.908** | 0.908 | 0.886 | 0.944 | 0.996 | 851px | 902px | [side-by-side](diff/sec-5.png) |
| sec-6 | partner-logos — The world’s best teams run on Remote | **0.963** | 0.980 | 0.971 | 0.907 | 0.919 | 560px | 508px | [side-by-side](diff/sec-6.png) |
| sec-7 | testimonials — A word from our customers | **0.958** | 0.957 | 0.936 | 0.993 | 0.906 | 805px | 811px | [side-by-side](diff/sec-7.png) |
...
| sec-9 | closing-cta — Global employment is hard. We built the infrastructure to do it right. | **0.953** | 0.952 | 0.934 | 0.986 | 0.906 | 440px | 434px | [side-by-side](diff/sec-9.png) |
| footer | footer (closing bookend) | **0.962** | 0.969 | 0.956 | 0.952 | 0.812 | 869px | 913px | [side-by-side](diff/footer.png) |
...
| contentSpanFidelity | 0.9462 | 0.8 | yes | rebuilt content occupies the measured share of each band |
...
2. **navbar — mega-menu open panels** (score 0.942): the brand declares mega-menu columns; the replica (and the source shot) render the closed bar only — open-panel fidelity is unexercised by this gate (diagnostic open-panel capture from the chrome preview: diff/chrome-mega-open.png)
3. **page — display font (Bossa)**: not self-hosted and not Google-loadable — headings render in the declared fallback stack; extract the woff2 files into assets/fonts/
