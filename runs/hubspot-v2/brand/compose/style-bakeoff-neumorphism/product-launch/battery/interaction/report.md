...
Generated: 2026-07-14T20:19:13+00:00 — auditor v1.0.0 — mode: strict
...
|---|---|---|---|
| compose/style-bakeoff-neumorphism/product-launch | `/Users/stanchev/Webflow/campaigns-hackathon/design-system-extractor-mine/runs/hubspot-v2/brand/compose/style-bakeoff-neumorphism/product-launch/index.html` | 2026-07-14T20:17:15+00:00 | `78c3dc5ce200` |
...
|---|---|---|---|---|---|
| IC-NAV-05 | nav | advisory | static | **advisory** | anchor with role=button in nav chrome — promises Space activation anchors don't have (line 2800) |
...
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Products' is a native button (line 2794) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Solutions' is a native button (line 2796) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Resources' is a native button (line 2798) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Products' carries aria-expanded (line 2794) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Solutions' carries aria-expanded (line 2796) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Resources' carries aria-expanded (line 2798) |
| IC-NAV-03 | nav | required | static | **pass** | no ARIA menu/menubar roles in site nav |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2794) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2796) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2798) |
