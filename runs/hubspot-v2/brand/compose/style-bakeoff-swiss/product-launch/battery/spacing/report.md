...
Generated 2026-07-28T23:52:07Z · viewport 1440x900 · contract: `brand_pipeline/spec/spacing-conformance.md` · tolerance: max(2px, 10%) for rhythm; max(2px, 1%) for widths; drift = within 2x tolerance.
...
`runs/hubspot-v2/brand/compose/style-bakeoff-swiss/product-launch/index.html` (mtime 2026-07-14 21:16:32)
