...
Generated: 2026-07-28T23:52:17+00:00 — auditor v1.0.0 — mode: strict
...
|---|---|---|---|
| compose/customer-story | `runs/hubspot-v2/brand/compose/customer-story/index.html` | 2026-07-17T17:46:49+00:00 | `e9896441a4a7` |
...
## Lane: compose/customer-story

| check | family | severity | layer | status | detail |
|---|---|---|---|---|---|
| IC-NAV-05 | nav | advisory | static | **advisory** | anchor with role=button in nav chrome — promises Space activation anchors don't have (line 3005) |
| IC-LANG-01 | lang | required | static | **pass** | toggle is a native <summary> inside <details> (line 2995) |
| IC-LANG-02 | lang | required | static | **pass** | toggle has an accessible name (line 2995) |
...
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Products' is a native button (line 2999) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Solutions' is a native button (line 3001) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Resources' is a native button (line 3003) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Products' carries aria-expanded (line 2999) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Solutions' carries aria-expanded (line 3001) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Resources' carries aria-expanded (line 3003) |
| IC-NAV-03 | nav | required | static | **pass** | no ARIA menu/menubar roles in site nav |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2999) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 3001) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 3003) |
