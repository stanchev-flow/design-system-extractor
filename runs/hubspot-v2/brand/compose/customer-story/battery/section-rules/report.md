...
Brand: `runs/hubspot-v2/brand` · 57 rules · 2026-07-28T23:52:20Z

## compose/customer-story — PASS (0 required fail(s), 0 advisory warn(s)) — scope: generative

| rule | scope | sev | verdict | detail |
|---|---|---|---|---|
| `SR-HDR-01` | section-header | req | PASS |  5 non-hero section heading(s) within the 2-line budget (half-measure columns license 3) |
...
| `SR-LOGO-01` | logo-strip | req | PASS | sec-5 declared itembox: mark heights within 0.0px |
| `SR-LOGO-02` | logo-strip | adv | PASS | sec-5 5 distinct mark(s) |
| `SR-QUOTE-01` | quote | req | PASS | sec-3 1 quote unit(s) marked; register below display |
| `SR-QUOTE-02` | quote | req | PASS | sec-3 1 quote(s) all attributed |
| `SR-QUOTE-04` | quote | adv | PASS | sec-3 1 quote(s) within 10-70 words |
| `SR-GRID-01` | feature-grid | req | PASS | sec-1 3 cell(s) share slot anatomy (bento lead exempt) |
| `SR-GRID-01` | feature-grid | req | PASS | sec-4 2 cell(s) share slot anatomy (bento lead exempt) |
| `SR-GRID-02` | feature-grid | adv | PASS | sec-1 3 parallel cell heading(s) |
| `SR-GRID-02` | feature-grid | adv | PASS | sec-4 2 parallel cell heading(s) |
| `SR-GRID-03` | feature-grid | adv | PASS | sec-1 3 cell bodies parallel in depth |
| `SR-GRID-03` | feature-grid | adv | PASS | sec-4 2 cell bodies parallel in depth |
| `SR-GRID-04` | feature-grid | adv | PASS | sec-1 3 icon box(es) uniform (median 36px ±10%) |
| `SR-GRID-04` | feature-grid | adv | PASS | sec-4 2 icon box(es) uniform (median 16px ±10%) |
| `SR-CTA-01` | cta-band | adv | PASS | sec-6 one decision moment (0w support) |
| `SR-CTA-03` | cta-band | adv | PASS | sec-6 primary label 'Get a demo' verb-led, 3 words |
...
delegated: SR-CTA-02, SR-FOOT-03, SR-GRID-05, SR-GRID-06, SR-HDR-03, SR-HERO-03, SR-LOGO-03, SR-NAV-02, SR-QUOTE-03, SR-STAT-05
skips: 10 (SR-GRID-01, SR-GRID-02, SR-GRID-03, SR-GRID-04, SR-HERO-05, SR-LOGO-04, capture-form, carousel, faq, pricing-tiers)
