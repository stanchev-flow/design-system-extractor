...
Generated: 2026-07-14T18:21:10+00:00 — auditor v1.0.0 — mode: strict
...
|---|---|---|---|
| compose/style-bakeoff-editorial-magazine/product-launch | `/Users/stanchev/Webflow/campaigns-hackathon/design-system-extractor-mine/runs/hubspot-v2/brand/compose/style-bakeoff-editorial-magazine/product-launch/index.html` | 2026-07-14T18:13:19+00:00 | `2058525034da` |
...
## Lane: compose/style-bakeoff-editorial-magazine/product-launch

| check | family | severity | layer | status | detail |
|---|---|---|---|---|---|
| IC-NAV-05 | nav | advisory | static | **advisory** | anchor with role=button in nav chrome — promises Space activation anchors don't have (line 2739) |
| IC-LANG-01 | lang | required | static | **pass** | toggle is a native <summary> inside <details> (line 2729) |
| IC-LANG-02 | lang | required | static | **pass** | toggle has an accessible name (line 2729) |
...
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Products' is a native button (line 2733) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Solutions' is a native button (line 2735) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Resources' is a native button (line 2737) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Products' carries aria-expanded (line 2733) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Solutions' carries aria-expanded (line 2735) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Resources' carries aria-expanded (line 2737) |
| IC-NAV-03 | nav | required | static | **pass** | no ARIA menu/menubar roles in site nav |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2733) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2735) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 2737) |
