...
- replica page: `index.html` → `replica-fullpage.png` (doc 7001px vs source 6986px)
...
| sec-7 | testimonial-tabs — section-7 | **0.955** | 0.953 | 0.935 | 0.988 | 0.842 | 714px | 723px | [side-by-side](diff/sec-7.png) |
