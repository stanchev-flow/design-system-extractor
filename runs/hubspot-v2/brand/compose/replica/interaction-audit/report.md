...
Generated: 2026-07-28T23:58:29+00:00 — auditor v1.0.0 — mode: strict
...
|---|---|---|---|
| compose/replica | `runs/hubspot-v2/brand/compose/replica/index.html` | 2026-07-28T23:45:48+00:00 | `0e71c4b89402` |
...
|---|---|---|---|---|---|
| IC-CAR-03 | carousel | advisory | static | **advisory** | no slide-level group/roledescription semantics (line 3659) |
| IC-NAV-05 | nav | advisory | static | **advisory** | anchor with role=button in nav chrome — promises Space activation anchors don't have (line 3464) |
| IC-CAR-01 | carousel | required | static | **pass** | prev/next controls are buttons with accessible names (line 3686) |
| IC-CAR-01 | carousel | required | static | **pass** | prev/next controls are buttons with accessible names (line 3525) |
| IC-CAR-02 | carousel | advisory | static | **pass** | container has aria-roledescription=carousel and a label (line 3659) |
| IC-CAR-02 | carousel | advisory | static | **pass** | container has aria-roledescription=carousel and a label (line 3500) |
| IC-CAR-03 | carousel | advisory | static | **pass** | slide containers use role=group + aria-roledescription=slide (line 3500) |
| IC-LANG-01 | lang | required | static | **pass** | toggle is a native <summary> inside <details> (line 3454) |
| IC-LANG-02 | lang | required | static | **pass** | toggle has an accessible name (line 3454) |
...
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Products' is a native button (line 3458) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Solutions' is a native button (line 3460) |
| IC-NAV-01 | nav | required | static | **pass** | trigger 'Resources' is a native button (line 3462) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Products' carries aria-expanded (line 3458) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Solutions' carries aria-expanded (line 3460) |
| IC-NAV-02 | nav | required | static | **pass** | trigger 'Resources' carries aria-expanded (line 3462) |
| IC-NAV-03 | nav | required | static | **pass** | no ARIA menu/menubar roles in site nav |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 3458) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 3460) |
| IC-NAV-04 | nav | advisory | static | **pass** | trigger references its panel via aria-controls (line 3462) |
...
| IC-TAB-01 | tabs | required | static | **pass** | tabs are native buttons with exactly one aria-selected (line 3718) |
| IC-TAB-02 | tabs | required | static | **pass** | tab↔panel aria-controls/aria-labelledby wiring is two-way (line 3718) |
| IC-TAB-03 | tabs | required | static | **pass** | roving tabindex + single visible focusable panel (line 3718) |
| IC-TAB-04 | tabs | advisory | static | **pass** | tablist has an accessible name (line 3718) |
...
| IC-CAR-04 | carousel | advisory | static | **skip** | no auto-rotation on this rail — pause-control contract not applicable (line 3659) |
| IC-CAR-04 | carousel | advisory | static | **skip** | no auto-rotation on this rail — pause-control contract not applicable (line 3500) |
