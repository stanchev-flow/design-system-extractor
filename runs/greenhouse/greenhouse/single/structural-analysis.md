...
consolidation_notes:
  likely_tokens:
    colors:
      - "inverse_dark_surface_green (~#133026)"
      - "inverse_text_high_emphasis (~#ffffff)"
      - "inverse_text_low_emphasis (~#FFFFFF)"
    gradients: []
    patterns: []
    background_systems:
      - "solid_inverse_strip"
...
observed_values:
  colors:
    - { id: canvas_mint, role: section_background, value_approx: "#FFFFFF", path: tree.children[1].style.background_color, confidence: medium }
    - { id: card_white, role: card_surface, value_approx: "#FFFFFF", path: tree.children[1].children[0].style.child_surface }
    - { id: green_solid, role: badge_surface, value_approx: "#4CB398", path: candidate_card.status_badge }
    - { id: teal_chip, role: chip_surface, value_approx: "#4CB398", path: source_pill_chip }
    - { id: dark_green_text, role: chip_text, value_approx: "#15372C", path: source_pill_chip.chip_text }
    - { id: near_black_text, role: nav_text, value_approx: "#133026", path: top_nav_continuation }
    - { id: blue_primary, role: primary_button_fill, value_approx: "#15372C", path: nav_demo_btn }
    - { id: muted_gray, role: card_meta_text, value_approx: "#15372C", path: candidate_card }
    - { id: brand_green_logo, role: logo_text, value_approx: "#15372C", path: nav_logo_slot }
  gradients: []
  patterns: []
  background_systems:
...
tree:
  ...
  style:
    background_color:
      role: section_canvas
      value: "deep desaturated green ~#133026"
      confidence: high
  layers:
    ...
    - id: main_dark_band
      ...
      style:
        background_color: "dark green ~#133026"
      implementation_assumption: likely_dom_or_layout_element
    - id: bottom_tonal_band
      ...
      style:
        background_color: "slightly lighter/greener ~#15372C"
...
tree:
  ...
  position:
    in_page: bottom
  style:
    background_color: "deep desaturated green, near #15372C (estimate)"
    background_confidence: high
  layers:
    - id: root_canvas_fill
      role: section_background
        ...
        - id: link_column_1
          ...
          children:
            - id: group_heading_a
              ...
              style:
                color: "muted/desaturated green, near #4CB398 (estimate)"
                font_category: sans_serif
                size: small
                weight: medium
                case: none
            - id: link_list_a
              ...
              items:
                ...
                representative_child:
                  ...
                  role: nav_link
                  style:
                    color: "off-white / pale cream, near #FFFFFF (estimate)"
                    font_category: serif
                    size: medium
                    weight: regular
                    underline: none
        ...
        - id: social_icons_row
          ...
          items:
            ...
            representative_child:
              ...
              style:
                shape: circle
                fill: "muted green, near #4CB398 (estimate)"
